...
class __TwigTemplate_f1a377693541589758cd88aa2a013c65 extends Template
{
...
";
    ...
    <button class=\"btn\">";
        // line 4
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((array_key_exists("button_label", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 4, $this->source); })()), "Reserver")) : ("Reserver")), "html", null, true);
        yield "</button>
";
        // line 5
...
";
    ...
    {
        return array (  60 => 5,  56 => 4,  52 => 3,  48 => 2,  45 => 1,);
    }
...
{{ form_start(form) }}
    {{ form_widget(form) }}
    <button class=\"btn\">{{ button_label|default('Reserver') }}</button>
{{ form_end(form) }}
", "reservation/_form.html.twig", "C:\\xampp\\htdocs\\systeme-reservation\\templates\\reservation\\_form.html.twig");
    }
}
