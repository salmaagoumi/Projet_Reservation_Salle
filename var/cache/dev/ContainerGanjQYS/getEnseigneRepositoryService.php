 ...
 */
class getEnseigneRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EnseigneRepository' shared autowired service.
     *
     * @return \App\Repository\EnseigneRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EnseigneRepository.php';

        return $container->privates['App\\Repository\\EnseigneRepository'] = new \App\Repository\EnseigneRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
